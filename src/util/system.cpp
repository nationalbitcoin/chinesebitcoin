...
const char * const BITCOIN_CONF_FILENAME = "chinesebitcoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\chinesebitcoin
    // macOS: ~/Library/Application Support/ChineseBitcoin
    // Unix-like: ~/.chinesebitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ChineseBitcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/ChineseBitcoin";
#else
    // Unix-like
    return pathRet / ".chinesebitcoin";
#endif
#endif
}
